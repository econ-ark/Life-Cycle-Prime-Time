...
As we discuss further below, when queried by the Survey of Consumer Finances about the most important reason to save, ``Liquidity / The Future'' is the most popular answer among retirees.
...
And as discussed above, the bequest motive is inconsistent with an investment manager's fiduciary duty to the client, as in the case of (e.g.) the sponsor of a 401(k) plan.

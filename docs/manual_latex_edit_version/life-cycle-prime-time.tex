...
Because the wealth-in-utility parameter $\delta$ can be informed by asking clients directly about their comfort with drawing down savings, the framework is well suited to personalized advice, whether delivered by a human planner or an automated tool.

...
\textbf{JEL Classification:} XXX, XXX

\vspace{1cm}

\textbf{Keywords:} \textit{words words words}
...
As mentioned above, the Fed has for many years asked respondents a question about their motivations for saving.\footnote{See \cite{FRB2023}, and specifically the material starting at line 848 in \href{https://www.federalreserve.gov/econres/files/bulletin.macro.txt}{the documentation}.}
...
\begin{figure}[t!]
	\centering
	\includegraphics[scale=0.7]{WealthMomentFit.pdf}
...
\begin{figure}[t!]
	\centering
	\includegraphics[scale=0.7]{StrongBequestMotive.pdf}
...
\begin{figure}[t!]
	\centering
	\includegraphics[scale=0.7]{ShareMomentFit.pdf}
...
\begin{figure}[t!]
\centering
\includegraphics[scale=0.7]{StockBeliefsShare.pdf}

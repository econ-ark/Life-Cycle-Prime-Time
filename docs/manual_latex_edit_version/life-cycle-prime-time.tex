...
\midrule
Life-Cycle & 1.049 & 9.195 &  &  &  \\
Portfolio & & & & & \\
Warm-Glow & 0.104 & 4.594 &  & 0.112 & 0.321 \\
LC Portfolio & & & & & \\
TRP / WIUF & 0.306 & 5.136 & 0.248 &  &  \\
LC Portfolio & & & & & \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.7\linewidth]{WealthMomentFit.pdf}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.7\linewidth]{StrongBequestMotive.pdf}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.7\linewidth]{ShareMomentFit.pdf}
...
\begin{figure}[t!]
\centering
\includegraphics[width=0.7\linewidth]{StockBeliefsShare.pdf}

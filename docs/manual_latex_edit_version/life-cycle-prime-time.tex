...
Modelers must always make difficult choices about which features to include to bolster its realism and which to forgo for the sake of computational burden.
...
For financial advisers who want to begin exploring life-cycle modeling and how they can incorporate it into their own advice, we humbly suggest looking into \href{http://www.github.com/econ-ark/HARK}{\texttt{HARK}}, our open source toolkit for solving and simulating dynamic stochastic optimization problems.
%\texttt{HARK} uses Python, and the latest version of the package can be installed using \texttt{pip} or \texttt{conda}.
We are constantly developing and improving our software, and have composed helpful documentation and tutorials, which can be installed locally with \texttt{HARK} or viewed through our \href{http://www.econ-ark.org}{website}.
The \href{http://www.github.com/econ-ark/life-cycle-prime-time}{GitHub repository} for this paper also includes the particular code we used to perform the estimations here, as well as an interactive Jupyter notebook to explore our results.
